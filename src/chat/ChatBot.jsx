...
const defaultResponses = [
    {
        keywords: [
            "que venden", "¿Qué vendes?", "qué venden", "qué ofrecen", "que ofrecen", "qué productos", "que productos", "qué tienen", "que tienen", "qué comercializan", "que comercializan", "qué puedo comprar", "que puedo comprar", "qué hay", "que hay"
        ],
...

    {
        ...
        response: "¡Entiendo! Si necesitas ayuda más adelante, puedes preguntarme sobre productos, servicios, contacto o ver la galería. ¿Te gustaría recibir alguna recomendación personalizada? Por ejemplo, puedes explorar la <a href='/Galeria' style='color:#0057b8;font-weight:bold;text-decoration:underline;'>galería</a> para inspirarte o ver nuestros <a href='/productos' style='color:#0057b8;font-weight:bold;text-decoration:underline;'>productos</a> destacados. Si prefieres, háblame de tú a tú."
    },
    ...
    {
        keywords: [
            "api", "integración", "documentación", "soporte técnico", "webhook", "endpoint", "json", "sdk", "desarrollador", "tecnología", "automatización", "soporte de sistemas", "infraestructura", "servidor", "deploy", "repositorio", "github", "backend", "frontend", "base de datos", "database", "rest", "restful", "microservicio", "microservicios"
        ],
